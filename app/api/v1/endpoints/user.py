...
def create_user(
    ...
    Этот эндпоинт добавляет нового пользователя в базу данных на
     основе предоставленных данных.

    **Параметры**:
    - `user` (UserCreate): Объект, содержащий данные для создания пользователя. Поля:
...
def issue_achievement(
    ...
    Этот эндпоинт позволяет добавить новое достижение пользователю.

    **Параметры пути**:
    - `user_id` (int): Уникальный идентификатор пользователя, которому нужно выдать достижение.
    ...
    **Возвращаемое значение**:
    - Объект `UserAchievementsOut`, содержащий информацию о выданном достижении, включая:
...
def read_users(db: SessionDep):
    ...
    Этот эндпоинт возвращает список всех пользователей, зарегистрированных в системе.
...
def get_user_achievements(
    ...
    """
    Получение всех достижений пользователя по его идентификатору.

    Этот эндпоинт возвращает список достижений, связанных с указанным пользователем.
    Достижения представляют собой набор данных, которые показывают, каких успехов
