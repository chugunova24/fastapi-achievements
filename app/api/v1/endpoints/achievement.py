...
def get_user_with_max_achievements(db: SessionDep):
    """
    Извлечь пользователя(ей) с максимальным
    количеством достижений.

    Этот эндпоинт возвращает пользователя(ей),
    заработавшего наибольшее количество достижений.
    Вычисляет пользователя(ей) с наибольшим
    количеством достижений и возвращает их данные,
    такие как идентификатор пользователя, имя и
...
def get_user_with_max_points(db: SessionDep):
    ...
    Этот эндпоинт возвращает пользователя(ей),
    заработавшего наибольшее количество очков.
    Вычисляет пользователя(ей) с наибольшим
    количеством очков и возвращает их данные,
    такие как идентификатор пользователя, имя
